...
var cropper_esm_exports = {};
__export(cropper_esm_exports, {
  default: () => cropper_esm_default
});
...
var IS_BROWSER, WINDOW, IS_TOUCH_DEVICE, HAS_POINTER_EVENT, NAMESPACE, ACTION_ALL, ACTION_CROP, ACTION_MOVE, ACTION_ZOOM, ACTION_EAST, ACTION_WEST, ACTION_SOUTH, ACTION_NORTH, ACTION_NORTH_EAST, ACTION_NORTH_WEST, ACTION_SOUTH_EAST, ACTION_SOUTH_WEST, CLASS_CROP, CLASS_DISABLED, CLASS_HIDDEN, CLASS_HIDE, CLASS_INVISIBLE, CLASS_MODAL, CLASS_MOVE, DATA_ACTION, DATA_PREVIEW, DRAG_MODE_CROP, DRAG_MODE_MOVE, DRAG_MODE_NONE, EVENT_CROP, EVENT_CROP_END, EVENT_CROP_MOVE, EVENT_CROP_START, EVENT_DBLCLICK, EVENT_TOUCH_START, EVENT_TOUCH_MOVE, EVENT_TOUCH_END, EVENT_POINTER_DOWN, EVENT_POINTER_MOVE, EVENT_POINTER_UP, EVENT_READY, EVENT_RESIZE, EVENT_WHEEL, EVENT_ZOOM, MIME_TYPE_JPEG, REGEXP_ACTIONS, REGEXP_DATA_URL, REGEXP_DATA_URL_JPEG, REGEXP_TAG_NAME, MIN_CONTAINER_WIDTH, MIN_CONTAINER_HEIGHT, DEFAULTS, TEMPLATE, isNaN, isPositiveNumber, hasOwnProperty, slice, assign, REGEXP_DECIMALS, REGEXP_SUFFIX, REGEXP_CAMEL_CASE, REGEXP_SPACES, onceSupported, location, REGEXP_ORIGINS, fromCharCode, REGEXP_DATA_URL_HEAD, render, preview, events, handlers, change, methods, AnotherCropper, Cropper, cropper_esm_default;
var init_cropper_esm = __esm({
  "node_modules/cropperjs/dist/cropper.esm.js"() {
    IS_BROWSER = typeof window !== "undefined" && typeof window.document !== "undefined";
    WINDOW = IS_BROWSER ? window : {};
    IS_TOUCH_DEVICE = IS_BROWSER && WINDOW.document.documentElement ? "ontouchstart" in WINDOW.document.documentElement : false;
    HAS_POINTER_EVENT = IS_BROWSER ? "PointerEvent" in WINDOW : false;
    NAMESPACE = "cropper";
    ACTION_ALL = "all";
    ACTION_CROP = "crop";
    ACTION_MOVE = "move";
    ...
    isPositiveNumber = function isPositiveNumber2(value) {
      return value > 0 && value < Infinity;
    };
    hasOwnProperty = Object.prototype.hasOwnProperty;
    slice = Array.prototype.slice;
    assign = Object.assign || function assign2(target) {
...
var require_VueCropper = __commonJS({
  "node_modules/vue-cropperjs/dist/VueCropper.js"(exports) {
    ...
    var _vue = (init_vue_runtime_esm_bundler(), vue_runtime_esm_bundler_exports);
    var _cropperjs = (init_cropper_esm(), cropper_esm_exports);
    ...
    exports.default = {
      ...
      methods: {
        ...
        move: function move2(offsetX, offsetY) {
          return this.cropper.move(offsetX, offsetY);
        },
        moveTo: function moveTo2(x) {
          var y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : x;
        ...
        zoomTo: function zoomTo2(ratio, _originalEvent) {
