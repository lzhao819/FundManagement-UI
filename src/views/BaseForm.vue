  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>Fund information</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      <div class="form-box">
...
<!--            <el-input v-model="form.name"></el-input>-->
            <el-select v-model="form.fund" placeholder="please choose fund">
          ...
          <el-form-item label="security" prop="region">
            <el-select v-model="form.security" placeholder="please choose">
...
<!--            <el-col :span="11">-->
              <el-form-item prop="date1">
                <el-date-picker type="date" placeholder="choose a date" v-model="form.date1"
  ...
  setup() {
    ...
    const onSubmit = () => {
      ...
      // });
         ...
         //    security_id: getSecurityType(form.security),  //API测试后改为form.date
         //    position_id: 10000,
         //    quantity: 666,
         //    date_purchased: '2021-8-26',
         //    funds_fund_id: getFundType(form.fund)
         //  })
