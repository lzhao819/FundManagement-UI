...
<!--                </el-select>-->
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column prop="firstName" label="基金名称"></el-table-column>
...
<!--                    </template>-->
<!--                </el-table-column>-->
                <el-table-column prop="LastName" label="manager名字"></el-table-column>
...
export default {
    ...
    setup() {
        ...
        const getData = () => {              //获取manager_info请求
          axios.get('localhost:8080/managers/'+ getPositionType())   //修改获取Manager_info的API
              .then(function (res) {
                console.log(res);
